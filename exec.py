...
content = prep.load_img('content4.jpg').to(device, dtype=torch.float)
style1 = prep.load_img('style3.jpg').to(device, dtype=torch.float)
style2 = prep.load_img('style4.jpg').to(device, dtype=torch.float)
